          ...
          <div class="col-lg-6">
           <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="Ajout_autres" method="post">
                <div class="col-12">
                   ...
                   <label for="inputNanme4" class="form-label">Profil</label>
                     ...
                     <div class="col-12">
                  <label for="inputNanme4" class="form-label">Coefficient</label>
                  <input type="text" class="form-control" id="inputNanme4" name="coeff">
                </div>
